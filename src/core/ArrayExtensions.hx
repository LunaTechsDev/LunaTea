...
class ArrayExtensions {
 ...
 public static inline function isProperSubsetOf<T>(array1: Array<T>,
   array2: Array<T>): Bool {
 ...
 public static inline function isSupersetOf<T>(array1: Array<T>,
   array2: Array<T>): Bool {
  return ArrayExtensions.isSubsetOf(array2, array1);
 }

 // array1.isSubsetOf(array2)
 public static inline function isSubsetOf<T>(array1: Array<T>,
   array2: Array<T>): Bool {
 ...
 public static inline function symmetricDifference<T>(array1: Array<T>,
 ...
 public static inline function symmetricDifferenceInPlace<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
 ...
 // array1.union(array2)
 public static inline function union<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
  return array1.concat(ArrayExtensions.difference(array2, array1));
 }

 // array1.unionInPlace(array2)
 public static inline function unionInPlace<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
 ...
 public static inline function difference<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
  return array1.filter((element: T) -> !array2.contains(element));
 }

 // array1.differenceInPlace(array2)
 public static inline function differenceInPlace<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
  // let i=0;; i++
  var i = 0;
  while (array1[i] != null) {
 ...
 public static inline function intersection<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
 ...
 public static inline function intersectionInPlace<T>(array1: Array<T>,
   array2: Array<T>): Array<T> {
  var i = 0;
  while (array1[i] != null) {
   while (array1[i] != null && !array2.contains(array1[i])) {
