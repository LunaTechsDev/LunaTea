...
public function statusWindowX(): Float;
...
public function helpAreaTop(): Float;
public function helpAreaBottom(): Float;
public function helpAreaHeight(): Float;
public function mainAreaTop(): Float;
public function mainAreaBottom(): Float;
public function mainAreaHeight(): Float;
public function buttonAreaTop(): Float;
public function windowAreaHeight(): Float;
